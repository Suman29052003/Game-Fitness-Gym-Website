...
const Section3 = () => {
  return (
    <section className='w-full min-h-[90vh] bg-[#35363a] flex justify-center items-center pb-8' id='program'>
      <div className="main-content w-[90%] md:w-[80%] pt-8 md:pt-0 md:grid grid-cols-2 grid-rows-2 gap-4 text-white">
        <div className="text-content-1 flex justify-center items-center ">
            <span className=" text-2xl md:text-5xl md:text-left text-center font-semibold">The Best Programs We Offers for You</span>
        </div>
        <div className="text-content-1 flex justify-center items-center  p-5">
            <p className="text-lg leading-8 text-justify md:text-left">We offer a wide range of comprehensive fitness programs designed for individuals of all fitness levels. Our aim to help your achieve specific goals and maximize results.</p>
        </div>

        <div className="card-grid col-span-2 grid md:grid-cols-4 gap-4">
            <div className="card-1 w-full bg-[#434343] rounded-lg flex flex-col px-8 py-12 gap-3 hover:bg-[#f5622b] transition-all duration-300 md:hover:scale-[1.05]">
            ...
            <div className="card-2 w-full bg-[#434343] rounded-lg flex flex-col px-8 py-12 gap-3 hover:bg-[#f5622b] transition-all duration-300 md:hover:scale-[1.05]">
                <figure className="w-[30%] h-16 flex justify-start items-start">
            ...
            <div className="card-3 w-full bg-[#434343] rounded-lg flex flex-col px-8 py-12 gap-3 hover:bg-[#f5622b] transition-all duration-300 md:hover:scale-[1.05]">
                <figure className="w-[30%] h-16 flex justify-start items-start">
            ...
            <div className="card-4 w-full bg-[#434343] rounded-lg flex flex-col px-8 py-12 gap-3 hover:bg-[#f5622b] transition-all duration-300 md:hover:scale-[1.05]">
                <figure className="w-[30%] h-16 flex justify-start items-start">
