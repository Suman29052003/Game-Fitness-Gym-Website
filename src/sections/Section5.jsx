...
<ul className="flex flex-col gap-4 text-xl">
    ...
    <li className="flex gap-4"><svg
        ...
        <div className="ac w-[80%] bg-[#434343] text-white flex flex-col justify-center items-center gap-4 py-6 rounded-xl hover:bg-[#f5622b] transition-all duration-300 hover:scale-[1.05]">
